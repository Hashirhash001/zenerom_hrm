        ...
        <div class="nk-sidebar-menu" data-simplebar>
            <ul class="nk-menu">
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(1) &&
                        session('user_privileges')->get(1)->can_view)
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(2) &&
                        session('user_privileges')->get(2)->can_view)
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(3) &&
                        session('user_privileges')->get(3)->can_view)
                    <li class="nk-menu-item has-sub">
                        <a href="javascript:void(0)" class="nk-menu-link nk-menu-toggle">
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(4) &&
                        session('user_privileges')->get(4)->can_view)
                    <li class="nk-menu-item has-sub">
                        <a href="javascript:void(0)" class="nk-menu-link nk-menu-toggle">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            @if (session()->has('user_privileges') &&
                                    session('user_privileges')->has(16) &&
                                    session('user_privileges')->get(16)->can_view)
                                <li class="nk-menu-item">
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(6) &&
                        session('user_privileges')->get(6)->can_view)
                    <li class="nk-menu-item has-sub">
                        <a href="javascript:void(0)" class="nk-menu-link nk-menu-toggle">
                ...
                @if (session()->has('user_privileges') &&
                        session('user_privileges')->has(7) &&
                        session('user_privileges')->get(7)->can_view)
                    <li class="nk-menu-item has-sub">
                        <a href="javascript:void(0)" class="nk-menu-link nk-menu-toggle">
