        ...
        <div class="container-fluid">
            <div class="nk-header-wrap">
                ...
                <div class="nk-header-brand d-xl-none">
                    <a class="logo-link">
                        <img class="logo-light logo-img" alt="logo" src="{{ asset('images/logo.png') }}"
                            alt="Logo" srcset="{{ asset('images/logo2x.png 2x') }}">
                        <img src="{{ asset('images/logo-dark.png') }}" srcset="{{ asset('images/logo-dark2x.png 2x') }}"
                            ...
                            <a class="dropdown-toggle" data-bs-toggle="dropdown">
                                <div class="user-toggle">
                                    <div class="user-avatar bg-primary">
                                        @if (session('image'))
                                            <img src="{{ asset('uploads/employees/' . session('image')) }}"
                                                alt="{{ $uname }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            ...
                                            <span class="sub-text">{{ session('role') }} | {{ session('department') }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-inner">
                                    <ul class="link-list">
                                        ...
                                        <li><a href="{{ route('reset.password') }}"><em
                                                    class="icon ni ni-setting-alt"></em><span>Reset Password</span></a>
                                        </li>
                                        <li><a href="html/user-profile-activity.html"><em
                                                    class="icon ni ni-activity-alt"></em><span>Login Activity</span></a>
                                        </li>
                                        <li><a class="dark-switch"><em class="icon ni ni-moon"></em><span>Dark
                                                    Mode</span></a></li>
                                    </ul>
                                </div>
                                <div class="dropdown-inner">
