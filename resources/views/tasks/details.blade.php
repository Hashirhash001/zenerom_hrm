        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div id="filterSection" class="mb-4">
                    ...
                    <form id="assignmentFilterForm" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="date" id="filterStartDate" class="form-control" name="filter_start_date">
                        </div>
                        <div class="col-md-3">
                            <label for="filterEndDate" class="form-label">End Date</label>
                            <input type="date" id="filterEndDate" class="form-control" name="filter_end_date">
                        </div>
                        <div class="col-md-3">
                            <label for="filterStaff" class="form-label">Assigned Staff</label>
                ...
                <div id="assignmentsList">
                    @if($task->assignments->count())
                        ...
                        <div class="card mb-3 assignment-card" 
                            ...
                            <div class="card-header">
                                <strong>Assigned To:</strong> {{ optional($assignment->staff)->first_name }} {{ optional($assignment->staff)->middle_name }} {{ optional($assignment->staff)->last_name }}
                                | <strong>Assigned By:</strong> {{ optional($assignment->creator)->first_name }} {{ optional($assignment->creator)->middle_name }} {{ optional($assignment->creator)->last_name }}
                  ...
                  <button class="btn btn-sm btn-danger deleteAssignmentBtn" data-assignment="{{ $assignment->id }}">Delete Assignment</button>
                </div>
                        </div>
                        @endforeach
                    @else
