            ...
            <div class="nk-sidebar nk-sidebar-fixed is-dark " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    ...
                    <div class="nk-sidebar-brand">
                        <img class="logo-light logo-img" alt="logo" src="{{ asset('images/zenerom_logo.png') }}"
                            alt="Logo" srcset="{{ asset('images/zenerom_logo.png 2x') }}">
                        <img src="{{ asset('images/zenerom_logo.png') }}"
                            srcset="{{ asset('images/zenerom_logo.png 2x') }}" alt="logo-dark"
