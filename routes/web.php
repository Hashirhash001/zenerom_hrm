...
// -------------------------------------------------------
// Protected routes (requires check.session middleware)
// -------------------------------------------------------
Route::middleware(['check.session'])->group(function () {

    // Attendance (moved from public)
    ...
    Route::delete('project-descriptions/{projectDescription}', [ProjectDescriptionController::class, 'destroy'])
        ->name('project_description.destroy');
    ...
    // Tasks (duplicate removed, kept one declaration)
    ...
    Route::post('my-tasks/{id}/status', [MyTaskController::class, 'updateStatus'])->name('my_tasks.update_status');
